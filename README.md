...
- 프리셋 기반 EAI 인터페이스 사전 생성(`preset.eai.enabled=true`일 때만, `memory/eai-dictionary/latest.md`, `latest.json`)
- EAI 기준일자(asOfDate) 및 override 관리(`docs/EAI_CATALOG_MAINTENANCE.md`)
